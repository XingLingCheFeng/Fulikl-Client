...
@Getter
@Setter
public class BindValue extends Value<String> {
    ...
    public BindValue(String name, String[] modes, String value) {
        super(name);
        this.modes = modes;
        this.setValue(value);
    ...
    public BindValue(String name, String[] modes) {
        super(name);
        this.modes = modes;
    ...
    public boolean containsValue(String string) {
        return Arrays.stream(modes).anyMatch(s -> s.equalsIgnoreCase(string));
    }
