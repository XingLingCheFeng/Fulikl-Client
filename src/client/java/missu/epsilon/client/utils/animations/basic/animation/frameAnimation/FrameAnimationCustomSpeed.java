...
public class FrameAnimationCustomSpeed {

    public static Float deltaTickCounter = 20.0f;

    public static float frameAnimation(boolean state, float currentTarget, float onStateTarget, float offStateTarget,float animationSpeed) {
